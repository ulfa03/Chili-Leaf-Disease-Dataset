...
Dataset ini terdiri dari **5000 gambar** yang terbagi ke dalam **5 kategori penyakit daun cabai**, masing-masing kategori berisi **1000 gambar**. Berikut rinciannya:

- 🌿 **Healthy Leaf** (Daun Sehat)
- 🍃 **Leaf Curl** (Daun Keriting)
- 🍂 **Leaf Spot** (Daun Bercak)
- 🧴 **Whitefly Leaf** (Daun Hama Putih)
- 💛 **Yellowish Leaf** (Daun Kuning)
